    ...
    <el-container>
      ...
      <el-container>
        <el-header>
          ...
          <div id="rt">
            <el-input type="text" placeholder="请输入" style="width:300px">
            ...
            <el-dropdown>
              <span class="el-dropdown-link">
                ...
                {{ name }}
                <i slot="prefix" class="el-icon-arrow-down el-icon--right"></i>
              </span>
  ...
  methods: {
    ...
    logout () {
      this.$confirm('确定要退出吗?', {
        ...
        .then(result => {
          window.sessionStorage.clear() // 清除浏览器sessionStorage 存储的信息
